...
declare module 'nightwatch' {
  ...
  export interface LanguageChains {
    to: NightWatchBrowser;
    be: NightWatchBrowser;
    been: NightWatchBrowser;
    is: NightWatchBrowser;
    that: NightWatchBrowser;
    which: NightWatchBrowser;
    and: NightWatchBrowser;
    has: NightWatchBrowser;
    have: NightWatchBrowser;
    with: NightWatchBrowser;
    at: NightWatchBrowser;
    of: NightWatchBrowser;
  }

  export interface Expect extends LanguageChains {
    ...
    */
    ...
    contains: (value: string) => NightWatchBrowser;
