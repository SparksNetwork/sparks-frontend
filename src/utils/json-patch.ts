...
module jsonpatch {
  var _objectKeys = function (obj: any) {
    if (_isArray(obj)) {
  ...
  var objOps = {
    add: function (obj: any, key: any) {
      obj[key] = this.value;
    },
    remove: function (obj: any, key: any) {
      var removed = obj[key];
      delete obj[key];
      return removed;
    },
    replace: function (obj: any, key: any) {
      var removed = obj[key];
      obj[key] = this.value;
      return removed;
    },
    move: function (obj: any, key: any, tree: any) {
      void obj;
      void key;
    ...
    copy: function (obj: any, key: any, tree: any) {
      void obj;
      void key;
    ...
    test: function (obj: any, key: any) {
      return _equals(obj[key], this.value);
    },
    _get: function (obj: any, key: any) {
      this.value = obj[key];
    }
  } as any;
  ...
  var arrOps = {
    add: function (arr: any, i: any) {
      arr.splice(i, 0, this.value);
      // this may be needed when using '-' in an array
      return i;
    },
    remove: function (arr: any, i: any) {
      var removedList = arr.splice(i, 1);
      return removedList[0];
    },
    replace: function (arr: any, i: any) {
      var removed = arr[i];
      arr[i] = this.value;
      return removed;
    },
    ...
    if (typeof operation !== 'object' || operation === null || _isArray(operation)) {
      ...
      if (operation.op == "add") {
        if (!existingPathFragment) {
          throw 'add : existingPathFragment must be truthy!';
        }
   ...
   * @param sequence
   * @param tree
   * @returns {JsonPatchError|null}
   */
  export function validate(sequence: any[], tree?: any): JsonPatchError|null {
    try {
